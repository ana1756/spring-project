...
public interface ApplicationService {
    ...
    List<Application> findByDeveloperSortedAndFiltered(Long id, String genre, String sorting);

    List<Application> getAllApplications();

    List<Application> getAllSortedAndFiltered(String genre, String sorting);
